...
![Web Server Role (IIS) Overview](images/05-web-server-role-overview.png)
![Installation Progress and Results](images/06-installation-progress.png)
...
![IIS Default Page in Browser (localhost)](images/07-iis-default-page-localhost.png)
...
![DNS Manager - www Host (A) Record Added in itech.local Zone](images/12-dns-manager-www-record.png)
![Custom Page Displayed at www.itech.local](images/13-custom-page-www-itech-local.png)
...
![IIS Manager - Adding a New Website (testing.local)](images/08-iis-manager-add-website.png)
![Setting Physical Path](images/09-add-website-browse-folder.png)
![Setting Port Binding (8080)](images/10-add-website-binding-8080.png)
![Sites List Showing Default Web Site and testing.local](images/11-sites-list-testing-local.png)
...
![Custom Web Page Displayed in Browser on PC-01](images/14-custom-page-client-pc01.png)
