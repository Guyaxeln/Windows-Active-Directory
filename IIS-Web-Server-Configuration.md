...
📸 *Selecting DC01.itech.local as the Destination Server*
📸 *Selecting the Web Server (IIS) Role and Adding Management Tools*
...
📸 *DNS Manager — www Host (A) Record Added in itech.local Zone*
📸 *Custom Page Displayed at www.itech.local*
...
📸 *IIS Manager — Adding a New Website (testing.local)*
📸 *Setting Physical Path and Port Binding*
📸 *Sites List Showing Default Web Site and testing.local*
...
📸 *Custom Web Page Displayed in Browser on PC-01*
